...
/**
 * Справочник признаков регистрации по адресу
 * 
 * <p>Java class for repatriationReason complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="repatriationReason"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "repatriationReason", propOrder = {
    "code",
    "nameRu",
    "nameKz",
    "changeDate"
})
public class RepatriationReason {
